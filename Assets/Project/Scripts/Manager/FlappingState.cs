...
public class FlappingState : PlayerState
{
    ...
    public override void EnterState()
    {
        ...
        // 在进入 flapping 状态时进行初始化
    }

    public override void UpdateLogic()
    {
        base.UpdateLogic();
        flapForceDirection = new Vector3(_sm.player.forward.x, 2f, _sm.player.forward.z).normalized;
    ...
    public override void UpdatePhysics()
    {
        ...
        Rigidbody rigidbody = _sm.player.GetComponent<Rigidbody>();
        // 给物体施加持续的向上力，抵抗重力
        rigidbody.AddForce(Vector3.up * flapUpwardForce, ForceMode.Acceleration);
        // 在此处添加 flipping 状态下的其他物理逻辑
